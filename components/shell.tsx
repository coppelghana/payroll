...
import { navigationForRole } from "@/lib/permissions";
import type { Profile } from "@/lib/security";

const navDetails: Record<string, [string, string]> = {
